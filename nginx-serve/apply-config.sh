...
find "$DESTINATION_DIRECTORY" -type f -exec sed -i "s|\<APP_CSRF_TOKEN_KEY_PLACEHOLDER\>|$APP_CSRF_TOKEN_KEY|g" {} +
find "$DESTINATION_DIRECTORY" -type f -exec sed -i "s|\<APP_GRAPHQL_API_ENDPOINT_PLACEHOLDER\>|$APP_GRAPHQL_API_ENDPOINT|g" {} +
find "$DESTINATION_DIRECTORY" -type f -exec sed -i "s|\<APP_GRAPHQL_CODEGEN_ENDPOINT_PLACEHOLDER\>|$APP_GRAPHQL_CODEGEN_ENDPOINT|g" {} +
