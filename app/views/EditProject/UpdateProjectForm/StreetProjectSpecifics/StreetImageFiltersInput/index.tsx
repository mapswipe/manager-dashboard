...
import { PartialStreetImageFiltersInputFields } from './schema.ts';

interface Props {
    value: PartialStreetImageFiltersInputFields | undefined | null;
    error: LeafError | ObjectError<PartialStreetImageFiltersInputFields>;
    setFieldValue: (
        ...entries: EntriesAsList<PartialStreetImageFiltersInputFields>
    ) => void;
    disabled?: boolean;
    imageProvider?: PartialStreetImageProviderInputFields | undefined | null;
}

function StreetImageFiltersInput(props: Props) {
    const {
        value,
        error: formError,
        setFieldValue,
...
export default StreetImageFiltersInput;
