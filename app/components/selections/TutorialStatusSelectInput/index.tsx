...
export type StatusOption = NonNullable<
    NonNullable<AllEnumsQuery['enums']>['TutorialStatusEnum']
>[number];
...
function TutorialStatusSelectInput(props: Props) {
    const {
        value,
        name,
        onChange,
    ...
    const allStatusOptions = allEnumsResponse?.enums?.TutorialStatusEnum;
...
export default TutorialStatusSelectInput;
